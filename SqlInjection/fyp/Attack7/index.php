...
<head>
	...
	<title>Attack 7- Error Based- String</title>
	<style>
h3{
	color:#afb5af;
	text-align:center;
...
<h3> <br> One of your friend is a member of city sports club. He forgets his username and password. He requested the club management to reset his password but they are not helping him out. They say that he have to register again with new username and password with a fee of 300$. Your friend dont have that much amount. You have to find a way to login to their system and get his account back.</h3>
</body>
</html>
