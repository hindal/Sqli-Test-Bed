...
<title>Attack9 Update Query- Error based - String</title>
<style>
h1{
	color:#afb5af;
	text-align:center;
...
<h1>Password reset <br> Online Hotel Service</h1>
...
<form action="" name="form1" method="post">
  ...
  <div style="color:white"> New Password : &nbsp; &nbsp;
...
<h3> <br><br>There is a site of hotel reservation which gives you an option to reset your account password. You have to convey them that the way they are offering reset option is not secure. You have to attack their system to show them that it is not secure </h3>
